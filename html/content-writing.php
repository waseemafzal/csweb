    ...
    <section class="banner banner-inner content-writing-banner">
        <div class="container">
            ...
            <div class="banner-txt">
                ...
                <p class="semi-bold">Creative contents are the key to convince your audience. It will
                    <br> help you to increase your conversion rate.</p>
    ...
    <section id="content-strategy" class="bg-white content-strategy concepts">
        <div class="container">
            ...
            <div class="hosting-content">
                <h2 class="b-clor">Content Strategy and Copywriting</h2>
                <hr class="dark-line">
            </div>
            <!-- End of .faqs-content -->
            <div class="row flex-wrapper">
                <div class="col-sm-6">
                    <div class="img-container">
                        <img src="images/branding.jpg" class="img-responsive" alt="research-img">
                    </div>
                </div>
                <div class="col-sm-6 flex-content flex-left">
                    <div class="content text-left">
                        <h3>Content with a Focus on Branding</h3>
            ...
            <div class="row flex-wrapper">
                <div class="col-sm-6">
                    <div class="img-container">
                        <img src="images/optimized-copy.jpg" class="img-responsive" alt="research-img">
                    </div>
                </div>
                <div class="col-sm-6 flex-content">
                    <div class="content text-left">
                        <h3>Optimized Copy for the Most Effective Landing Pages</h3>
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/content-writing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:58 GMT -->
</html>