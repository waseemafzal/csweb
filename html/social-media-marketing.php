...
<!--end header-->
    ...
    <!-- ++++ end banner ++++ -->
    <!-- ++++ service description ++++ -->
    <section class="bg-white o-hidden common-form-section  service-description-section" id="result-oriented-marketing">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor">Result Oriented Marketing</h2>
            <hr class="dark-line" />
            <!--end section title -->
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    <h3 class="semi-bold">Create Great Customer Engagement</h3>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="images/case-studies/case-7.jpg" class="img-responsive" alt="seo-case-studies" />
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="images/case-studies/case-6.jpg" class="img-responsive" alt="seo-case-studies" />
                        <div class="box-content-text">
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/social-media-marketing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:43 GMT -->
</html>