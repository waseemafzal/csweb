...
<!--end header-->
    ...
    <section class="banner  o-hidden banner-inner pay-per-click-banner">
        <div class="container">
            ...
            <div class="banner-txt">
                <h1>Pay-Per-Click</h1>
                <p class="semi-bold">Increase website traffic very quickly by paid search engine
                    <br /> advertisement.
                </p>
    ...
    <section class="bg-white o-hidden common-form-section  service-description-section">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor">Pay Only for Actual Advertisement</h2>
            <hr class="dark-line" />
            <!--end section title -->
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    <h3 class="semi-bold">Quickest Way to Increase Traffic</h3>
                    ...
                    <ul>
                        <li>
                            <span class="icon-pen"></span>Quickest Way to Increase Traffic</li>
                        <li>
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/pay-per-click.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:43 GMT -->
</html>