...
<head>
    ...
    <meta name="description" content="Progressive Web apps and Native android and ios mobile apps.">
    <!-- keywords -->
    <meta name="keywords" content="android, php, web development, mobile apps">
    <meta charset="utf-8">
    ...
    <link rel="apple-touch-icon" sizes="114x114" href="public/icon/apple-touch-icon-114x114">
    <!-- ++++ bootstrap ++++ -->
