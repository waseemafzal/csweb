    ...
    <section class="banner  o-hidden banner-inner case-studies-banner">
        <div class="container">
            ...
            <div class="banner-txt">
                <h1>Case Studies</h1>
                <p class="semi-bold">Learn how we helped our several clients grow in online business.
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="public/images/case-studies/case-7.jpg" class="img-responsive" alt="seo-case-studies" />
                        <div class="box-content-text">
                            <h3 class="semi-bold">First Derivatives</h3>
                            <p class="regular-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="public/images/case-studies/case-6.jpg" class="img-responsive" alt="seo-case-studies" />
                        <div class="box-content-text">
                            <h3 class="semi-bold">Legacy Classic</h3>
                            <p class="regular-text">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="public/images/case-studies/case-3.jpg" class="img-responsive" alt="seo-case-studies" />
                        <div class="box-content-text">
                            <h3 class="semi-bold">CA Technologies</h3>
                            <p class="regular-text">Li Europan lingues es membres del sam familie. Lor separat existentie es un myth. Por scientie,
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="public/images/case-studies/case-1-1.jpg" class="img-responsive" alt="seo-case-studies" />
                        <div class="box-content-text">
                            <h3 class="semi-bold">Hewlett Packard</h3>
                            <p class="regular-text">Lor separat existentie es un myth. Por scientie, musica, sport etc, litot Europa usa li sam vocabular.
                                Li lingues differe solmen in li grammatica.</p>
                            <a href="case-studies-details.html" class="medium-btn2 btn btn-fill ">VIEW DETAILS</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="public/images/case-studies/case-5.jpg" class="img-responsive" alt="seo-case-studies" />
                        <div class="box-content-text">
                            <h3 class="semi-bold">Microsoft</h3>
                            <p class="regular-text">Ma quande lingues coalesce, li grammatica del resultant lingue es plu simplic e regulari quam
                                ti del coalescent lingues. Li nov lingua franca va esser plu simplic e regulari quam</p>
                            <a href="case-studies-details.html" class="medium-btn2 btn btn-fill ">VIEW DETAILS</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="box-content-with-img">
                        <img src="public/images/case-studies/case-4.jpg" class="img-responsive" alt="seo-case-studies" />
                        <div class="box-content-text">
                            <h3 class="semi-bold">Periscope Data</h3>
                            <p class="regular-text">Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur,
                                ...
                                <div id="carousel-bounding-box">
                                    <div id="myCarousel" class="carousel slide">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="active item" data-slide-number="0" style="background: url('public/images/portfolio/portfolio-details-slider-one.jpg')">
                                            </div>
                                            <div class="item" data-slide-number="1" style="background: url('public/images/portfolio/portfolio-details-slider-two.jpg')"> </div>
                                            <div class="item" data-slide-number="2" style="background: url('public/images/portfolio/portfolio-details-slider-three.jpg')"> </div>
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/case-studies.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:03:22 GMT -->
</html>