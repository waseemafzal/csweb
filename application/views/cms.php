...
<?php $banner = base_url().'upload/'.$row->banner; ?>
    <!-- ++++ banner ++++ -->
    <section class="banner  o-hidden banner-inner logo-branding-banner" style="background:url('<?php echo $banner ?>')">
        <div class="container">
    ...
    <section class="bg-white design-process-section margin-bottom-30" id="process-tab">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor text-align-center">Our <?php 
				echo $row->title; ?> Process</h2>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <?php 
				$count=	count($processArray);
					if($count>0){
						$i=1;
						foreach($processArray as $pdata){
							$activeClass='';
							if($i==1){
								$activeClass='active';
								}
					?>
                        <li role="presentation">
                            <a href="#process<?php echo $pdata['id'] ;?>" class="<?php echo $activeClass ;?>" aria-controls="exploration" role="tab" data-toggle="tab">
                                <span class="<?php echo $pdata['icon_class'] ;?>"></span>
				...
				$count=	count($processArray);
					...
					?>
                        <div role="tabpanel" class="tab-pane <?=$activeClass?>" id="process<?php echo $pdata['id'] ;?>">
                            <div class="design-process-content">
                                <h3 class="semi-bold"><?php echo $pdata['title'] ;?></h3>
                                <?php echo $pdata['description'] ;?>
                                  <?php  $image = base_url().'upload/'.$pdata['image'] ;?>
                                <img src="<?=$image?>" alt="<?php echo $pdata['title'] ;?>" class="img-responsive" /> </div>
                        </div>
                        <?php 
						$i++;
						} } ?>
