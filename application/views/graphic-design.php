...
<!--end header-->
    ...
    <section class="bg-white o-hidden common-form-section service-description-section">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor"> Stunning Graphic/Print Design</h2>
            <hr class="dark-line" />
            <!--end section title -->
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    <h3 class="semi-bold">We'll Design the Best Marketing Materials for you.</h3>
                    ...
                    <ul>
                        <li>
                            <span class="icon-vector"></span>Design that attracts customers.</li>
                        <li>
    ...
    <section class=" bg-white design-process-section margin-bottom-30" id="process-tab">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor text-align-center">Our Graphic Design Process</h2>
            <p class="regular-text text-align-center">Our comprehensive graphic design strategy ensures a perfectly crafted website for your business.</p>
            <!--end section title -->
            <div class="row">
                <div class="col-xs-12">
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/graphic-design.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:24 GMT -->
</html>