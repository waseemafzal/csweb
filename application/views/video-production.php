...
<!--end header-->
    ...
    <!-- ++++ banner ++++ -->
    <section class="banner  o-hidden banner-inner video-production-banner">
        <div class="container">
            <!--banner text-->
            <div class="banner-txt">
                <h1>Video Production</h1>
                <p class="semi-bold">Videos create greater impact on your customers through
                    <br> interactive video production.</p>
                <a href="#process-tab" class="medium-btn3 btn btn-nofill page-scroll">Our Process</a>
            </div>
            <!--end banner text-->
        </div>
    </section>
    ...
    <section class="bg-white o-hidden common-form-section service-description-section">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor">Corporate Video Production</h2>
            <hr class="dark-line" />
            <!--end section title -->
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    <h3 class="semi-bold">Increase Marketing Engagement</h3>
                    ...
                    <ul>
                        <li>
                            <span class="icon-camera"></span>Design mobile app that directly connects your audience.</li>
                        <li>
                            <span class="icon-lollipop"></span>Beautiful and modern design that makes difference.</li>
                        <li>
                            <span class="icon-rocket"></span>Boost your sales with strategically designed marketing materials.</li>
                    </ul>
                    <p class="regular-text">
                        <p class="regular-text no-margin">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                            ut laoreet dolore magna. Quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip
                            ex ea commodo consequat. Dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
    ...
    <section class=" bg-white design-process-section margin-bottom-30" id="process-tab">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor text-align-center">Our Video Production Process</h2>
            <p class="regular-text text-align-center">Our comprehensive video production strategy ensures a perfectly crafted website for your business.</p>
            <!--end section title -->
            <div class="row">
                <div class="col-xs-12">
                    <!-- design process steps-->
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs process-model row text-center process-video-modal" role="tablist">
                        ...
                        <li role="presentation" class="col-sm-3">
                            <a href="#wire-frame" aria-controls="wire-frame" role="tab" data-toggle="tab">
                                <span class="icon-camera-play"></span>
                                <p>Shooting</p>
                            </a>
                        </li>
                        <li role="presentation" class="col-sm-3">
                            <a href="#final-design" aria-controls="final-design" role="tab" data-toggle="tab">
                                <span class="icon-desktop"></span>
                                <p>Editing</p>
                            </a>
                        </li>
                        <li role="presentation" class="col-sm-3">
                            <a href="#final-video" aria-controls="final-design" role="tab" data-toggle="tab">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="consultation">
                            <div class="design-process-content">
                                ...
                                <p class="regular-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincid
                                    unt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis
                                    nostrud exerci tation ullam corper suscipit lobortis nisl ut aliquip ex ea commodo consequat.
                                    Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p>
                                <p class="regular-text">Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas
                                    est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum.</p>
                                <img src="public/images/design-process-img.jpg" alt="design process" class="img-responsive" /> </div>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="wire-frame">
                            <div class="design-process-content">
                                ...
                                <p class="regular-text">Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas
                                    est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum.</p>
                                <img src="public/images/seo-discovery.jpg" alt="design process" class="img-responsive" /> </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="final-video">
                            <div class="design-process-content">
                                <h3 class="semi-bold">Final Video</h3>
                                <p class="regular-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincid
                                    unt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis
                                    nostrud exerci tation ullam corper suscipit lobortis nisl ut aliquip ex ea commodo consequat.
                                    Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p>
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            ...
                            <div class="overlay video_popup">
                                <a href="https://www.youtube.com/watch?v=Fz-6MdlPY1M" class="video-popup">
                                    <span class="icon-play-circle"></span>
                                </a>
                            </div>
                            <!-- End of .overlay -->
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            ...
                            <div class="overlay video_popup">
                                <a href="https://www.youtube.com/watch?v=rrT6v5sOwJg" class="video-popup">
                                    <span class="icon-play-circle"></span>
                                </a>
                            </div>
                            <!-- End of .overlay -->
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/video-production.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:24 GMT -->
</html>