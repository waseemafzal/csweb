...
<!--end header-->
    ...
    <!-- ++++ banner ++++ -->
    <section class="banner banner-inner business-stategy-banner">
        <div class="container">
            <!--banner text-->
            <div class="banner-txt">
                <h1>Digital Strategy</h1>
                <p class="semi-bold">Brand directly represents your business. We will spend time creating
                    <br> the best strategy to build a brand for your business.</p>
                <a href="#brand-strategy" class="medium-btn2 btn btn-nofill page-scroll">READ MORE</a>
            </div>
            <!--end banner text-->
        </div>
    </section>
    ...
    <section id="brand-strategy" class="bg-white concepts">
        <div class="container">
            <!--section title -->
            <div class="hosting-content">
                <h2 class="b-clor">Building a Business with Brand Strategy</h2>
                <hr class="dark-line">
            </div>
            <!-- End of .faqs-content -->
            <div class="row flex-wrapper">
                <div class="col-sm-6">
                    <div class="img-container">
                        <img src="public/images/competitors.jpg" class="img-responsive" alt="research-img">
                    </div>
                </div>
                <div class="col-sm-6 flex-content flex-left">
                    <div class="content text-left">
                        <h3>Competitors and Industry Analysis</h3>
            ...
            <div class="row flex-wrapper">
                <div class="col-sm-6">
                    <div class="img-container">
                        <img src="public/images/re-engaging-audience.jpg" class="img-responsive" alt="research-img">
                    </div>
                </div>
                <div class="col-sm-6 flex-content">
                    <div class="content text-left">
                        <h3>Re-engaging Your Audience with a Brand Refresh</h3>
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/digital-strategy.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:44 GMT -->
</html>