        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    ...
                    <ul>
                        <li>
                            <span class="icon-clipboard-pencil"></span>Get free SEO audit.</li>
                        <li>
                            <span class="icon-find-replace"></span>Thorough optimization to increase rank.</li>
                        <li>
                            <span class="icon-laptop-phone"></span>Keywords and landing page integration.</li>
                    </ul>
                    <p class="regular-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/search-engine-optimization.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:35 GMT -->
</html>