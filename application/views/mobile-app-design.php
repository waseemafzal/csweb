...
<!--end header-->
    ...
    <!-- ++++ banner ++++ -->
    <section class="banner  o-hidden banner-inner mobile-app-banner">
        <div class="container">
            <!--banner text-->
    ...
    <section class="bg-white o-hidden common-form-section service-description-section">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor">Mobile First Concept</h2>
            <hr class="dark-line" />
            <!--end section title -->
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    <h3 class="semi-bold">Design Mobile Apps Based on Business Strategy</h3>
                    ...
                    <ul>
                        <li>
                            <span class="icon-phone"></span>Design mobile app that directly connects your audience.</li>
                        <li>
    ...
    <section class="bg-white design-process-section margin-bottom-30" id="process-tab">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor text-align-center">Our App Design Process</h2>
            <p class="regular-text text-align-center">Our comprehensive App design strategy ensures a perfectly crafted logo for your business.</p>
            <!--end section title -->
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <ul class="nav nav-tabs process-model more-icon-preocess" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#exploration" aria-controls="exploration" role="tab" data-toggle="tab">
                                <span class="icon-magnifier"></span>
                                <p>Exploration</p>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#sketches" aria-controls="sketches" role="tab" data-toggle="tab">
                                <span class="icon-pencil3"></span>
                                <p>Sketches</p>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#digitization" aria-controls="digitization" role="tab" data-toggle="tab">
                                <span class="icon-vector"></span>
                                <p>Digitization</p>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#color" aria-controls="color" role="tab" data-toggle="tab">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="exploration">
                            <div class="design-process-content">
                                ...
                                <img src="public/images/design-process-img.jpg" alt="seo process" class="img-responsive" /> </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="color">
                            <div class="design-process-content">
                                ...
                                <p class="regular-text">Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas
                                    est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. </p>
                                <img src="public/images/seo-discovery.jpg" alt="seo process" class="img-responsive" /> </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row margin-top-40 logo-b portfolio">
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            <img src="public/images/portfolio/mobile-4.jpg" alt="port_img" class="img-responsive">
                            <div class="overlay">
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            <img src="public/images/portfolio/mobile-2.jpg" alt="port_img" class="img-responsive">
                            <div class="overlay">
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            <img src="public/images/portfolio/mobile-1.jpg" alt="port_img" class="img-responsive">
                            <div class="overlay">
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/mobile-app-design.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:18 GMT -->
</html>