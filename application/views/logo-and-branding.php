<?php include_once"includes/header.php" ?>
    ...
    <section class="bg-white o-hidden common-form-section  service-description-section" id="branding-matters">
        <div class="container">
            <!--section title -->
            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    ...
                    <ul>
                        <li>
                            <span class="icon-leaf"></span>Modern and evergreen logo for your business.</li>
                        <li>
                            <span class="icon-users"></span>Branding that stands out in the crowd.</li>
                        <li>
                            <span class="icon-road-sign"></span>Strategic approach towards redesigning brand.</li>
                    </ul>
                    <p class="regular-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
        ...
        <div class="container">
            ...
            <div class="row margin-top-40 logo-b portfolio">
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            <img src="public/images/portfolio/logo-2.jpg" alt="port_img" class="img-responsive">
                            <div class="overlay">
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            <img src="public/images/portfolio/logo-3.jpg" alt="port_img" class="img-responsive">
                            <div class="overlay">
                ...
                <div class="col-xs-6 col-sm-4">
                    <div class="grid-item">
                        <div class="img_container">
                            <img src="public/images/portfolio/logo-4.jpg" alt="port_img" class="img-responsive">
                            <div class="overlay">
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/logo-and-branding.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:16 GMT -->
</html>