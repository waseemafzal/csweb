...
<!--end header-->
    ...
    <section class=" bg-white design-process-section margin-bottom-30" id="process-tab">
        <div class="container">
            <!--section title -->
            <h2 class="b-clor text-align-center">Our Mobile App Development Process</h2>
            <p class="regular-text text-align-center">Our comprehensive mobile app development strategy ensures a perfectly crafted website for your business.</p>
            <!--end section title -->
            <div class="row">
                <div class="col-xs-12">
                                                ...
                                                <ul class="list-inline  thumb-list">
                                                    <li>
                                                        <a id="carousel-selector-0" class="carousel-selector selected">
                                                            <img src="public/images/portfolio/portfolio-slider-thum-1.jpg" class="img-responsive" alt=""> </a>
                                                    </li>
                                                    <li>
                                                        <a id="carousel-selector-1" class="carousel-selector">
                                                            <img src="public/images/portfolio/portfolio-slider-thum-2.jpg" class="img-responsive" alt=""> </a>
                                                    </li>
                                                    <li>
                                                        <a id="carousel-selector-2" class="carousel-selector">
                                                            <img src="public/images/portfolio/portfolio-slider-thum-3.jpg" class="img-responsive" alt=""> </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
<!-- Mirrored from themes.axilweb.com/html/marketo/modern-big-digital-agency/mobile-app-development.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2017 15:02:28 GMT -->
</html>