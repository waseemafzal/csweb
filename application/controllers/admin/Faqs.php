...
class Faqs extends CI_Controller {
	...
	$array=array();
	$array['modeltitle']='Faqs';
	$array['data']=	$this->model->getData(); 	
	$this->load->view('admin/Faqs',$array);			
	}
	...
	public function save(){
		...
		$this->form_validation->set_rules('question', 'full question','required');
		...
		if ($this->form_validation->run() == FALSE)
                ...
                else
                {
				  ...
				  // print_r($_POST);exit;
				   $data=array('question'=>$question,'category'=>$category,'description'=>$description); 
					if(isset($id) and $id!=''){
